...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM2001_F1_ARMCD_DM2F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM2001_F1_ARMCD_DM2F1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM2001_F1_ARMCD_DM2F1_3.sql >> RWRBatch.log
