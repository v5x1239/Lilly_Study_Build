rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igSG1_F1_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_SG1001_LF1_igSG1_F1_S2_1.xml
...
where p.pagerefname='SG1001_LF1'
  and s.sectionrefname='igSG1_F1_S2'
