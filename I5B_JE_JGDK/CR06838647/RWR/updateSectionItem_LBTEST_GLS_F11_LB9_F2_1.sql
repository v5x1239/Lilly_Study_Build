rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_LBTEST_GLS_F11_LB9_F2_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_LBTEST_GLS_F11_LB9_F2_1.xml
...
from pf_item i,
     pf_section s
where i.itemrefname='LBTEST_GLS_F11_LB9_F2'
