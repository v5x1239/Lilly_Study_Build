rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_LBRESMD_F11_LB9001_F2_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_LBRESMD_F11_LB9001_F2_1.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'I5B_JE_JGDK 1.0.12')
/
