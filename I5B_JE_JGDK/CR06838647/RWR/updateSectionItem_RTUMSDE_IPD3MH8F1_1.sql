rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_RTUMSDE_IPD3MH8F1_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_RTUMSDE_IPD3MH8F1_1.xml
...
from pf_item i,
     pf_section s
where i.itemrefname='RTUMSDE_IPD3MH8F1'
