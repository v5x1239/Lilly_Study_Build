...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_STATIXE_F3_igSTATUS_F3_S1_1.sql >> RWRBatch.log
...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSU1001_F2_S1_SUDAT_SU1001_F2_1.sql >> RWRBatch.log
...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM1001_F3_S1_BRTHYR_DM1001_F3_1.sql >> RWRBatch.log
...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSU5001_F1_S1_SUDAT_SU5001_F1_1.sql >> RWRBatch.log
...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDA1001_F1_S1_DADAT_DISPAMT_DA1001_F1_1.sql >> RWRBatch.log
