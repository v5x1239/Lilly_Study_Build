...
spool updateSectionItem_igINFC2001_PR1001_F1_S1_INFCSLOCMD_INFC2PR1_F1_1.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'I4V_MC_JAHN 1.0.0')
/
