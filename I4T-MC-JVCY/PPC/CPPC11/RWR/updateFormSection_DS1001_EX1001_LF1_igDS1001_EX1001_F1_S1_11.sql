...
SPOOL updateFormSection_DS1001_EX1001_LF1_igDS1001_EX1001_F1_S1_11.xml
...
where p.pagerefname='DS1001_EX1001_LF1'
  and s.sectionrefname='igDS1001_EX1001_F1_S1'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'I4T_MC_JVCY 5.0.48')
/
