...
SPOOL updateFormSection_MH8001_IPD3001_LF1_igMH8001_IPD3001_F1_S2_5.xml
...
where p.pagerefname='MH8001_IPD3001_LF1'
  and s.sectionrefname='igMH8001_IPD3001_F1_S2'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'RWRI3Y_CR_JPBQ 4.1.47')
/
