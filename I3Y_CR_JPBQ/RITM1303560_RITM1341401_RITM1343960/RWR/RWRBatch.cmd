...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMMDX2001_IPD3001_F1_S1_MMDXASMDAT_MMDX2IPD3F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMMDX2001_IPD3001_F1_S1_MMDXASMDAT_MMDX2IPD3F1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMMDX2001_IPD3001_F1_S1_MMDXASMDAT_MMDX2IPD3F1_3.sql >> RWRBatch.log
