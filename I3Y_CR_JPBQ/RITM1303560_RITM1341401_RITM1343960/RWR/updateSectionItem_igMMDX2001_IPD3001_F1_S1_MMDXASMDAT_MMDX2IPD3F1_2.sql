...
spool updateSectionItem_igMMDX2001_IPD3001_F1_S1_MMDXASMDAT_MMDX2IPD3F1_2.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'I3Y_CR_JPBQ 2.0.47')
/
