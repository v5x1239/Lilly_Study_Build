...
CODE NAME (required)              : I8B-MC-ITRN_ECOA_HEADER.sas
...
DATA INPUT                        : \\IX1LECFS02.rf.lilly.com\icon.grp\DS_END\219268_I8B-MC-ITRN\ecoa\*.*
OUTPUT                            : Excel
...
%let prot 				= I8B_MC_ITRN;								/* Icon study code 					 									*/
