...
CODE NAME (required)              : I8B-MC-ITRN_ECOA_LISTINGS.sas
...
DATA INPUT                        : \\IX1LECFS02.rf.lilly.com\icon.grp\DS_END\219269_I8B-MC-ITRN\ecoa\*.*
OUTPUT                            : Excel
...
%let icon_code 			= l02191269;								/* Icon study code 					 									*/
%let study_path 		= \\IX1LECFS02.rf.lilly.com\icon.grp\DS_END\219269_I8B-MC-ITRN;			/* Icon root path 					 									*/
...
%let output_file_name 	= I8B_MC_ITRN_ECOA_LISTINGS;		/* Output file name, if applicable 		*/
...
/*libname clntrial oracle dbprompt=yes defer=no path=prd934 access=READONLY schema=I8B_MC_ITRN;*/
...
%excel_add_tab (DIAB_eCOA_URI_Recon1a, "Exception based report to identify missing Gluc from BG1001", "");
%excel_add_tab (DIAB_eCOA_URI_Recon1b, "Exception based report to identify missing Meals from BG1001", "");
%excel_add_tab (DIAB_eCOA_URI_Recon2a, "Exception based report to identify missing MLDCARB from ML3001", "");
