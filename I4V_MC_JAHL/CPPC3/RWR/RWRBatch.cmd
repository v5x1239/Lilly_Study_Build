...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_CM2001_LF2_igCM2001_F2_S1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_CM2001_LF2_igCM2001_F2_S1_3.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM1001_F1_S1_BRTHYR_DM1001_F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM1001_F1_S1_BRTHYR_DM1001_F1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM1001_F1_S1_BRTHYR_DM1001_F1_3.sql >> RWRBatch.log
