rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igMHPRESP1001_F1_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igMHPRESP1001_F1_1.xml
...
where p.pagerefname='MHPRESP1001_F1'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'I3Y_MC_JPBX 1.0.0')
/
