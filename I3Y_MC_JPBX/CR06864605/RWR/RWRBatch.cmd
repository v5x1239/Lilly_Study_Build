...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_igMHPRESP1001_F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_igMHPRESP1001_F1_2.sql >> RWRBatch.log
@echo >> RWRBatch.log
