...
CODE NAME (required)              : RS013.sas
PROJECT NAME (required)           : I3O_MC_JSBF
DESCRIPTION (required)            : If Overall response is “Complete response”, ensure that all Target Tumor States are "Absent"  and Non-target Tumor States are "Absent" and no new Tumor(s) appeared. (if lymph nodes included: they should have reduced to <10mm) 
...
select /*a.merge_datetime,*/ b.SITEMNEMONIC, a.SUBJID, /*a.TULNKID,*/ c.TRSPID, 
	c.TRDAT/*, a.TUMSTATE*/
...
select /*a.merge_datetime,*/ b.SITEMNEMONIC, a.SUBJID, 
	/*a.TULNKID,*/ c.TRSPID, c.TRDAT/*, a.TUMSTATE*/
...
proc sql;
create table RS013 as 
select /*a.merge_datetime,*/ a.SITEMNEMONIC, a.SUBJID, a.RSPERF, a.RSDAT, a.RSSPID, a.OVRLRESP,
	/*b.TULNKID,*/ b.TRSPID, b.TRDAT/*, b.TUMSTATE*/
from RS a left join TU b
on a.SITEMNEMONIC=b.SITEMNEMONIC and 
	a.SUBJID=b.SUBJID and 
	a.RSSPID=b.TRSPID
where /*(datepart(a.merge_datetime) > input("&date", ? Date9.)) and */ strip(lowcase(a.OVRLRESP))~='complete response'
	/*and (b.TUMSTATE~='' or b.TUMSTATE=b.TRSPID)*/
...
/*Print RS013*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
title1 "Overall Response";
title2 "If Overall response is “Complete response”, ensure that all Target Tumor States are 'Absent' and Non-target Tumor States are 'Absent' and no new Tumor";
  proc print data=RS013 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
