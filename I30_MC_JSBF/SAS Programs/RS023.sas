...
CODE NAME (required)              : RS023.sas
PROJECT NAME (required)           : I3O_MC_JSBF
DESCRIPTION (required)            : If Non-Target Response is Complete Response, ensure that Tumor States for all Non-Target tumors are "Absent". 
...
select /*a.merge_datetime,*/ b.SITEMNEMONIC, a.SUBJID/*, a.TULNKID, a.TRSPID,
	a.TRDAT, a.TUMSTATE, a.TUMSTATE_NONTARGET */
...
proc sql;
create table RS023 as 
select /*a.merge_datetime,*/ a.SITEMNEMONIC, a.SUBJID, a.RSPERF, a.RSDAT, a.RSSPID/*, 
	a.TRGRESP, b.TULNKID, b.TRSPID, b.TRDAT, b.TUMSTATE, b.TUMSTATE_NONTARGET */
from RS a left join TU_3 b
on a.SITEMNEMONIC=b.SITEMNEMONIC and 
	a.SUBJID=b.SUBJID /*and 
	a.RSSPID=b.TRSPID*/
/*where strip(lowcase(b.TRGRESP))~='complete response' and b.TUMSTATE_NONTARGET~=''*/
...
/*Print RS023*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
title1 "Non-Target Response";
  title2 "If Non-Target Response is Complete Response, ensure that Tumor States for all Non-Target tumors are 'Absent'.";

  proc print data=RS023 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
