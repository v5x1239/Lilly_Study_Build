...
SPOOL updateFormSection_VS1001_C5LF1_igVS1001_C5F1_S1_1.xml
...
where p.pagerefname='VS1001_C5LF1'
  and s.sectionrefname='igVS1001_C5F1_S1'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'I3O_MC_JSBF 1.0.0')
/
