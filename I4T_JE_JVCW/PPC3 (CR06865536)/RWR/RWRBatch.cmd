...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_IRAD3001_LF1_igIRAD3001_F1_S2_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_IRAD3001_LF1_igIRAD3001_F1_S2_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_IRAD3001_LF1_igIRAD3001_F1_S2_3.sql >> RWRBatch.log
