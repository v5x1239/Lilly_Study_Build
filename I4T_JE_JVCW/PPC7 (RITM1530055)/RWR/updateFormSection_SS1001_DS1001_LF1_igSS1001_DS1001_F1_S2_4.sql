...
SPOOL updateFormSection_SS1001_DS1001_LF1_igSS1001_DS1001_F1_S2_4.xml
...
where p.pagerefname='SS1001_DS1001_LF1'
  and s.sectionrefname='igSS1001_DS1001_F1_S2'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'RWRI4T_JE_JVCW 2.1.46')
/
