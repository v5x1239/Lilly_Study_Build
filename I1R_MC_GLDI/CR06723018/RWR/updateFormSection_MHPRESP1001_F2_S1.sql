rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_MHPRESP1001_F2_S1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_MHPRESP1001_F2_S1.xml
...
where p.pagerefname='MHPRESP1001_F2'
