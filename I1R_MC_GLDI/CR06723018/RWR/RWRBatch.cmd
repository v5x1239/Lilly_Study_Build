...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_MHPRESP1001_F1_S1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_MHPRESP1001_F2_S1.sql >> RWRBatch.log
@echo >> RWRBatch.log
