...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_MHDXDAT_MHPRESP1001_F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_MHDXDAT_MHPRESP1001_F2_1.sql >> RWRBatch.log
@echo >> RWRBatch.log
