rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_MHDXDAT_MHPRESP1001_F2_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_MHDXDAT_MHPRESP1001_F2_1.xml
