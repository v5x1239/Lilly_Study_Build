rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igHEPA1001_F1_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igHEPA1001_F1_S2_1.xml
...
where p.pagerefname='HEPA1001_F1'
  and s.sectionrefname='igHEPA1001_F1_S2'
