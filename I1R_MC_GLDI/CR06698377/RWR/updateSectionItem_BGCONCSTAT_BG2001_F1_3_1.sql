rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_BGCONCSTAT_BGCONCSTAT_BGCONCSTAT_BGCONCSTAT_BG2001_F1_3_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_BGCONCSTAT_BG2001_F1_3_1.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'I1R_MC_GLDI 1.0.0')
/
