rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_BGCONCSTAT_BGCONCSTAT_BG2001_F1_1_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_BGCONCSTAT_BG2001_F1_1_1.xml
...
from pf_item i,
     pf_section s
where i.itemrefname='BGCONCSTAT_BG2001_F1_1'
