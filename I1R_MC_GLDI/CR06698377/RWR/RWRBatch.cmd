...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_BGCONCSTAT_BG2001_F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_BGCONCSTAT_BG2001_F1_1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_BGCONCSTAT_BG2001_F1_2_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_BGCONCSTAT_BG2001_F1_3_1.sql >> RWRBatch.log
@echo >> RWRBatch.log
