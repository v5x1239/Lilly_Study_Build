...
spool updateSectionItem_igCSSBS1001_F1_S1_CSSBS105_CMPD_CSSB1001_F1_1.xml
...
from pf_item i,
     pf_section s
where i.itemrefname='CSSBS105_CMPD_CSSB1001_F1'
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'I4V_MC_JAHM 1.0.0')
/
