...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMMDX2001_F2_S1_MMDXRES119_MMDX2001_F2_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMMDX2001_F1_S1_MMDXRES119_MMDX2F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMMDX2001_F3_S1_MMDXRES119_MMDX2001_F3_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMMDX2001_F4_S1_MMDXRES120_MMDX2001_F4_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igIHC4001_F1_S1_MIRESMD_IHC4F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igIHC4001_F2_S1_MIRESMD_IHC4F2_1.sql >> RWRBatch.log
