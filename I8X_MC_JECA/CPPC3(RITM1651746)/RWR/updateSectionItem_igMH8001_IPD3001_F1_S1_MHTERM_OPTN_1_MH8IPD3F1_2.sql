...
spool updateSectionItem_igMH8001_IPD3001_F1_S1_MHTERM_OPTN_1_MH8IPD3F1_2.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'I8X_MC_JECA 2.0.10')
/
