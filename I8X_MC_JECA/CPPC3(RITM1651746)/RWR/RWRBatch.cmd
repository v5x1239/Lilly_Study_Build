...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMH8001_IPD3001_F1_S1_MHTERM_OPTN_1_MH8IPD3F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMH8001_IPD3001_F1_S1_MHTERM_OPTN_1_MH8IPD3F1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igMH8001_IPD3001_F1_S1_MHTERM_OPTN_1_MH8IPD3F1_3.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSU3001_F2_S1_SUNCF_TOBACCO_SU3001_F2_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSU3001_F2_S1_SUNCF_TOBACCO_SU3001_F2_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSU3001_F2_S1_SUNCF_TOBACCO_SU3001_F2_3.sql >> RWRBatch.log
