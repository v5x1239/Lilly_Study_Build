...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM2001_F1_PLN_ARMCD_1_DM2F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM2001_F1_PLN_ARMCD_1_DM2F1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM2001_F1_PLN_ARMCD_1_DM2F1_3.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDM2001_F1_PLN_ARMCD_2_DM2F1_4.sql >> RWRBatch.log
