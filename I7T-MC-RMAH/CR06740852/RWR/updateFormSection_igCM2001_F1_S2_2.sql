rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_section_igCM2001_F1_S2_2.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_section_igCM2001_F1_S2_2.xml
...
where p.pagerefname='CM2001_F1'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'I7T_MC_RMAH 2.0.1')
/
