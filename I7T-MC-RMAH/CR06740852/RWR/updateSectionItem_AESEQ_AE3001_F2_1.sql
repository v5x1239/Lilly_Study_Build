rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_AESEQ_AE3001_F2_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_AESEQ_AE3001_F2_1.xml
