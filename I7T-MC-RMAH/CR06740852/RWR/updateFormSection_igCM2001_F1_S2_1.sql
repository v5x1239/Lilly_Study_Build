rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_section_igCM2001_F1_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_section_igCM2001_F1_S2_1.xml
...
where p.pagerefname='CM2001_F1'
  and s.sectionrefname='igCM2001_F1_S2'
