rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_section_igCM1001_F1_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_section_igCM1001_F1_S2_1.xml
...
where p.pagerefname='CM1001_F1'
  and s.sectionrefname='igCM1001_F1_S2'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'I7T_MC_RMAH 1.0.261')
/
