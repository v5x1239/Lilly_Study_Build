rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_section_igAE3001_F2_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_section_igAE3001_F2_S2_1.xml
...
where p.pagerefname='AE3001_F2'
  and s.sectionrefname='igAE3001_F2_S2'
