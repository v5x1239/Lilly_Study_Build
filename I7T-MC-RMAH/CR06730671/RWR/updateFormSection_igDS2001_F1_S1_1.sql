rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_section_igDS2001_F1_S1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_section_igDS2001_F1_S1.xml
...
where p.pagerefname='DS2001_F1'
  and s.sectionrefname='igDS2001_F1_S1'
