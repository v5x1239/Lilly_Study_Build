...
proc sql;
create table CM as 
select a.merge_datetime, b.SITEMNEMONIC, a.SUBJID, a.CMSPID ,a.CMTRT, a.CMENDAT
...
/*Print CM016*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 "Concomitant Therapy";
title2 "Treatment End Date must be <= the date subject discontinued study";
  proc print data=CM016 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
