...
proc sql;
create table CM as 
select a.merge_datetime, b.SITEMNEMONIC, a.SUBJID, a.AEGRIPID,a.AETERM, c.AEENDAT
...
/*Print AE022A*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 "Adverse Event";
title2 "Event End Date  must be <= last visit date";
  proc print data=AE022A noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
