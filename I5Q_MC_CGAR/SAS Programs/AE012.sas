...
proc sql;
create table AE012 as 
select a.MERGE_DATETIME,b.SITEMNEMONIC,a.subjid,a.AEGRPID,a.AETERM,a.AEDECOD,c.AESTDAT,c.AEONGO,c.AEENDAT,c.AESER
...
/*Print AE012*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 "Adverse Event";
title2 "Solicited signs and symptoms of primary study condition must be reported as Adverse Events";
  proc print data=AE012 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
