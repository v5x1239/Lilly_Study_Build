...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_CM3001_LF1_igCM3001_F1_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igPSSI2001_F1_S1_QSEVALIN_PSSI2F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igPPASI2001_F1_S1_QSEVALIN_PPASI2F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igNAPSI2001_F1_S12_QSEVALIN_NAPSI2F1_1.sql >> RWRBatch.log
