...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igLB9001_F3_S1_LBTPT_LB9F3_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igLB9001_F1_S1_LBTPT_LB9F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_ECOG1001_LF1_igECOG1001_F1_S2_1.sql >> RWRBatch.log
