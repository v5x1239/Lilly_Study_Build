...
SPOOL updateFormSection_ECOG1001_LF1_igECOG1001_F1_S2_1.xml
...
where p.pagerefname='ECOG1001_LF1'
  and s.sectionrefname='igECOG1001_F1_S2'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'I9L_MC_JZCA 1.0.0')
/
