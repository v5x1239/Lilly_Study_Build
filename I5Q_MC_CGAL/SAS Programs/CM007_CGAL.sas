	...
	create table CM007 as
		select merge_datetime,SUBJID, CMSPID,  CMTRT, CMSTDAT, CMONGO, CMENDAT, CMINDC, CMAEGRPID4,CMMHNO4, CMDOSE, CMDOSEU, CMDOSFRQ, CMROUTE, CMDECOD, CMTRADNM, CMCLAS, CMCLASCD
			from clntrial.CM1001_d
				where datepart(MERGE_DATETIME) > input("&date",Date9.) and CMDECOD in ('ACENOCOUMAROL', 'ADALIMUMAB', 'ANTICONVULSANTS', 
					'ANTIEPLILEPTICS', 'ANTIPSYCHOTICS', 'BACLOFEN', 'BARBITURATES', 'BOTULINUM TOXIN', 'CANDESARTAN', 'CANNABINOIDS', 'CANNABIS',
					'CAPSAICIN', 'CIVAMIDE', 'CORTICOSTERIODS', 'COUMADIN', 'CRANIAL NERVE BLOCK', 'DEXTRIAMPHETAMINE', 'DIHYDROERGOTAMINE',
					'ERGOT DERIVATIVES', 'ERGOTAMINE', 'ETANCEREPT', 'FLUNARIZINE', 'HEPARIN', 'HERBALS', 'INDOMETHACIN', 'INFLIXIMAB', 
					'INTRANASAL CAPSAICIN', 'INTRANASAL LIDOCAINE', 'LITHIUM', 'MAOI', 'MELATONIN', 'MEMANTINE', 'METHERGINE', 'METHLYPHENIDATE',
					'METHYSERGIDE', 'MISOPROSTOL', 'MIXED AMPHETAMINE SALTS', 'MODAFINIL', 'NEFAZODONE', 'NEUROSTIMULATION', 'OCTREOTIDE',
					'OPIOIDS', 'PIZOTIFEN', 'SOMATOSTATIN', 'STIMULANTS', 'TCA', 'THERAPEUTIC ANTIBODIES', 'TRASTUZUMAB', 'TRIPTANS', 'VERAPAMIL');
quit;
