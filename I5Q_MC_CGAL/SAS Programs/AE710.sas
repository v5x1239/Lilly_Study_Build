...
proc sql;
	create table ae as
	select A.*, b.blockid  as blockid1, AESTEXR2
from clntrial.ae_dump a left join clntrial.AESTEX10 b
on a.subjid=b.subjid
where AESTEXR2='N' and AEREL='Y';
quit;

proc sql;
	create table AE710 as 
select distinct a.MERGE_DATETIME, a.SUBJID, a.AEGRPID, AETERM, AEREL,AESTDAT, b.blockid  as blockid2, EXSTDAT, blockid1, AESTEXR2
...
/*Print AE710*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 "If  AE start date = date of injection received in V3 or V9";

  proc print data=AE710 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
