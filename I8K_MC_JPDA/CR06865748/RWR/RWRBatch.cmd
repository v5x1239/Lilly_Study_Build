...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_STATGUT_F5_igSTATGUT_F5_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_STATGUT_F6_igSTATGUT_F6_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_STATGUT_F7_igSTATGUT_F7_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_AE4001_LF2_igAE4001a_F2_S1_1.sql >> RWRBatch.log
