rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igSV1001_F2_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igSV1001_F2_S2_2.xml
...
where p.pagerefname='SV1001_F2'
  and s.sectionrefname='igSV1001_F2_S2'
