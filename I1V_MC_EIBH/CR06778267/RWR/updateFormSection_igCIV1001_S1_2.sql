rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igCIV1001_S1_2.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igCIV1001_S1_2.xml
...
where p.pagerefname='CIV1001'
  and s.sectionrefname='igCIV1001_S1'
