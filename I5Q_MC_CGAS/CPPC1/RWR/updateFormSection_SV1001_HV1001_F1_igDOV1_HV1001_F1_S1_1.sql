...
SPOOL updateFormSection_SV1001_HV1001_F1_igDOV1_HV1001_F1_S1_1.xml
...
where p.pagerefname='SV1001_HV1001_F1'
  and s.sectionrefname='igDOV1_HV1001_F1_S1'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'I5Q_MC_CGAS 1.0.0')
/
