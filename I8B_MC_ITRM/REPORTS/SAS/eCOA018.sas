...
input('20JUL2017',date9.) as STUDY_START_DATE format date9. label 'Study Start Date' from
...
where ((bgdat is not null and bgdat < input('20JUL2017',date9.)) OR (bgdat1 is not null and bgdat1 < input('20JUL2017',date9.))
OR (bgdat2 is not null and bgdat2 < input('20JUL2017',date9.))) order by subjid, bgdat, bgdat1, bgdat2; quit;
