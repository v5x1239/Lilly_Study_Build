...
DESCRIPTION (required)            : Check that the date of Severe Hypoglycemic events not associated with Visit 8 or Visit 18 do not match the date of any MMTT dose.
...
where HYPOSTDAT ne '' and visitnum = .;
...
if a and b and EXSTDAT = HYPOSTDAT;
run;

ods csv file=&irfilcsv trantab=ascii;
  title1 "eCOA710";
  title2 "Check that the date of Severe Hypoglycemic events not associated with Visit 8 or Visit 18 do not match the date of any MMTT dose.";
