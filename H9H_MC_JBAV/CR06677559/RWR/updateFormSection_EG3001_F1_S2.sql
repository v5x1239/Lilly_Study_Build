rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_EG3001_F1_S2.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_EG3001_F1_S2.xml
...
where p.pagerefname='EG3001_F1'
  and s.sectionrefname='igEG3001_F1_S2'
