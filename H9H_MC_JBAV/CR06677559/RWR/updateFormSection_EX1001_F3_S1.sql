rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_EX1001_F3_S1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_EX1001_F3_S1.xml
...
where p.pagerefname='EX1001_F3'
  and s.sectionrefname='igEX1001_F3'
