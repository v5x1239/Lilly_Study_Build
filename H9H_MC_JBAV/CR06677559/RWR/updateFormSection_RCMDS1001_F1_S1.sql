rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_RCMDS1001_F1_S1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_RCMDS1001_F1_S1.xml
...
where p.pagerefname='RCMDS1001_F1'
  and s.sectionrefname='igRCMDS1001_F1_S1'
