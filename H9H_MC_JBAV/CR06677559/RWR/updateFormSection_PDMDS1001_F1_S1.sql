rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_PDMDS1001_F1_S1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_PDMDS1001_F1_S1.xml
...
where p.pagerefname='PDMDS1001_F1'
  and s.sectionrefname='igPDMDS1_F1_S1'
