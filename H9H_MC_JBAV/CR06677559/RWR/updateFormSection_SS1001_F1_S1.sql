rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_SS1001_F1_S1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_SS1001_F1_S1.xml
...
where p.pagerefname='SS1001_F1'
  and s.sectionrefname='igSS1001_F1'
