rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_CGABN1001_F1_S2.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_CGABN1001_F1_S2.xml
...
where p.pagerefname='CGABN1001_F1'
  and s.sectionrefname='igCGABN1001_F1_S2'
