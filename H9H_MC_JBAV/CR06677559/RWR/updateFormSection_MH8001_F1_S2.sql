rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_MH8001_F1_S2.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_MH8001_F1_S2.xml
...
where p.pagerefname='MH8001_F1'
  and s.sectionrefname='igMH8001_F1_S2'
