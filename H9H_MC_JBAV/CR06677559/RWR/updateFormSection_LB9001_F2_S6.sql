rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_LB9001_F2_S6.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_LB9001_F2_S6.xml
...
where p.pagerefname='LB9001_F2'
  and s.sectionrefname='igLB9001_F2_S6'
