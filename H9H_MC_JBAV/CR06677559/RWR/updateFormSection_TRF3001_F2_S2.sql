rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_TRF3001_F2_S2.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_TRF3001_F2_S2.xml
...
where p.pagerefname='TRF3001_F2'
  and s.sectionrefname='igTRF3001_F2_S2'
