rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igDM1001_F1_S1_2.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igDM1001_F1_S1_2.xml
...
where p.pagerefname='DM1001_F1'
  and s.sectionrefname='igDM1001_F1_S1'
