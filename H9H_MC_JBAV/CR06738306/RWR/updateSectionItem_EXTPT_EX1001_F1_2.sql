rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_EXTPT_EX1001_F1_2.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_EXTPT_EX1001_F1_2.xml
...
from pf_item i,
     pf_section s
where i.itemrefname='EXTPT_EX1001_F1'
