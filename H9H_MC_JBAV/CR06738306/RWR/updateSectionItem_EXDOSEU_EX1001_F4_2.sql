rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_EXDOSEU_EX1001_F4_2.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_EXDOSEU_EX1001_F4_2.xml
