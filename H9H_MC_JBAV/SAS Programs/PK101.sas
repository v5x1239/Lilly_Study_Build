...
CODE NAME (required)              : PK_101.sas
PROJECT NAME (required)           : IR1-MC-GLDI
DESCRIPTION (required)            : Duplicate test - more then required visits per patient
...
by subjid visit;
if a and b and count2 > freq;
Dup_Lab_Freq = Count2 - freq;
drop count count2 freq;
run;

/*Print list of exception terms.*/
ods csv file=&irfilcsv trantab=ascii;
  title1 "Duplicate test - more then required visits per patient";
