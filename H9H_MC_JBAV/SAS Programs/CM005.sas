...
CODE NAME (required)              : CM005.sas
PROJECT NAME (required)           : I1R_MC_GLDI
DESCRIPTION (required)            : CM1001 Events Not Coded Consistantly or Missing
...
proc freq data=clntrial.CM1001 noprint;
...
proc print data=CM_terms_coding;
  title1 "CM1001 Events Not Coded Consistantly or Missing";
run;
ods csv close;
