rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_LBNAMCD_LB9_F5_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_LBNAMCD_LB9_F5_1.xml
