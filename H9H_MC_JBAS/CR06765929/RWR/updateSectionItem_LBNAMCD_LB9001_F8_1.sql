rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_LBNAMCD_LB9001_F8_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_LBNAMCD_LB9001_F8_1.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'H9H_MC_JBAS 1.0.238')
/
