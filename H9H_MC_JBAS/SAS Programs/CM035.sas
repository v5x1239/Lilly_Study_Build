...
proc sql;
	...
	where a.subjid=b.subjid and a.CMMHNO = b.mhspid and a.CMENDAT lt b.MHSTDAT;
	quit;
...
ods csv file=&irfilcsv trantab=ascii;
  ...
  proc print data=CM035 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
