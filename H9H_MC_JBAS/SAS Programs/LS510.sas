...
CODE NAME (required)              : LS510.sas
PROJECT NAME (required)           : H9H-MC-JBAS
DESCRIPTION (required)            : Ensure measurements are appropriate (in mm) - check for outliers.  
...
/*Print LS510*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 "Ensure measurements are appropriate (in mm) - check for outliers.";

  proc print data=LS510 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
