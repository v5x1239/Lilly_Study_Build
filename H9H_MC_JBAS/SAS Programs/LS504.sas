...
CODE NAME (required)              : LS504.sas
PROJECT NAME (required)           : H9H-MC-JBAS
DESCRIPTION (required)            : Ensure location assigned to a particular lesion are consistent from visit to visit.
...
/*Print LS504*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 "Ensure location assigned to a particular lesion are consistent from visit to visit.";
  proc print data=LS504 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
