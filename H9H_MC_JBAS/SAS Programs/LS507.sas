...
CODE NAME (required)              : LS507.sas
PROJECT NAME (required)           : H9H-MC-JBAS
DESCRIPTION (required)            : Ensure method of measurement is consistent from one assessment of lesions to the next assessment, starting at baseline.
...
/*Print LS507*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 "Ensure method of measurement is consistent from one assessment";
title2 "of lesions to the next assessment, starting at baseline.";
  proc print data=LS507 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
