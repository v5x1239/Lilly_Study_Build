...
CODE NAME (required)              : LS509.sas
PROJECT NAME (required)           : H9H-MC-JBAS
DESCRIPTION (required)            :  If PET CT was performed and demonstrated objective progressive disease, the date of progression can be the date of the PET CT as long as the CT portion of the PET was of diagnostic quality.  Otherwise, a follow-up CT should have been performed.  If the follow-up CT confirms the PD, then date of PD should be the date of the early PET scan.
...
/*Print LS509*/ * Replace AA001 with report name;
ods csv file=&irfilcsv trantab=ascii;
  title1 " If PET CT was performed and demonstrated objective progressive disease,"; 
title2 "the date of progression can be the date of the PET CT as long as";
title3 "the CT portion of the PET was of diagnostic quality.";
title4 "Otherwise, a follow-up CT should have been performed. If the follow-up CT";
title5 "confirms the PD, then date of PD should be the date of the early PET scan.";
  proc print data=LS509 noobs WIDTH=min; 
    var _all_;
  run;
ods csv close;
