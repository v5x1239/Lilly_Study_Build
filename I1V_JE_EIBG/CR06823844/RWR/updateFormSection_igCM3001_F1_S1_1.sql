rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igCM3001_F1_S1_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igCM3001_F1_S1_1.xml
...
where p.pagerefname='CM3001_F1'
  and s.sectionrefname='igCM3001_F1_S1'
