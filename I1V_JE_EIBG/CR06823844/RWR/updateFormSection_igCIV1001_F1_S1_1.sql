rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igCIV1001_F1_S1_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igCIV1001_F1_S1_1.xml
...
where p.pagerefname='CIV1001_LF1'
  and s.sectionrefname='igCIV1001_F1_S1'
