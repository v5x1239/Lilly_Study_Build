...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSTATUS_F4_S1_STATUS_STATUS_F4_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSTATUS_F4_S1_STATUS_STATUS_F4_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igSTATUS_F4_S1_STATUS_STATUS_F4_3.sql >> RWRBatch.log
