rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igIBD1001_SGLB9XP_F1_LAST_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igIBD1001_SGLB9XP_F1_LAST_1.xml
...
where p.pagerefname='IBD1_LB9_F1'
  and s.sectionrefname='igIBD1001_SGLB9XP_F1_LAST'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'Study Design 1.0.0')
/
