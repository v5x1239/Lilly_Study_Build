rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igIBD1SG1LB9XP1_F1_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igIBD1SG1LB9XP1_F1_S2_1.xml
...
where p.pagerefname='IBD1_SG1_XP1_F1'
  and s.sectionrefname='igIBD1SG1LB9XP1_F1_S2'
