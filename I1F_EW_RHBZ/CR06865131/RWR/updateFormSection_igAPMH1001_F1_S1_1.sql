rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igAPMH1001_F1_S1_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igAPMH1001_F1_S1_1.xml
...
where p.pagerefname='APMH1001_F1'
  and s.sectionrefname='igAPMH1001_F1_S1'
