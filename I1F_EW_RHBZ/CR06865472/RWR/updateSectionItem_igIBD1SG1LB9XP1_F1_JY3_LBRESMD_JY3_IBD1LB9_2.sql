...
spool updateSectionItem_igIBD1SG1LB9XP1_F1_JY3_LBRESMD_JY3_IBD1LB9_2.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'RWRI1F_EW_RHBZ 1.1.40')
/
