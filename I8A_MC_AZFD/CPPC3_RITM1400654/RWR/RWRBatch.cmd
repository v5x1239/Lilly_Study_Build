...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS1001_LF4_igDS1001_F4_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS1001_LF4_igDS1001_F4_S1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS1001_LF4_igDS1001_F4_S1_3.sql >> RWRBatch.log
