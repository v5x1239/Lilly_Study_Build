...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS2001_LF3_igDS2001_F3_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS2001_LF3_igDS2001_F3_S1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS2001_C1LF3_igDS2001_C1F3_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS2001_C1LF3_igDS2001_C1F3_S1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS2001_C2LF3_igDS2001_C2F3_S1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_DS2001_C2LF3_igDS2001_C2F3_S1_2.sql >> RWRBatch.log
...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igDS1001_F4_S1_DSDECOD_DS1F4_2.sql >> RWRBatch.log
