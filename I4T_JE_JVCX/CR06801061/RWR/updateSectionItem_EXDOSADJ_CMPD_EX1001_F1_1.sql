rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_EXDOSADJ_CMPD_EX1001_F1_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_EXDOSADJ_CMPD_EX1001_F1_1.xml
