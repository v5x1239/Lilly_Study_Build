rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igEXCMP1001_F1_S1_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igEXCMP1001_F1_S1_1.xml
...
where p.pagerefname='EXCMP1001_F1'
  and s.sectionrefname='igEXCMP1001_F1_S1'
