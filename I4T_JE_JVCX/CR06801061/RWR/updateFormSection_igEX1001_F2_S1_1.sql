rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igEX1001_F2_S1_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igEX1001_F2_S1_1.xml
...
where p.pagerefname='EX1001_F2'
  and s.sectionrefname='igEX1001_F2_S1'
