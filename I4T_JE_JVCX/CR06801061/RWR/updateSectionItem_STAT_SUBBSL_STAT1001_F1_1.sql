rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_STAT_SUBBSL_STAT1001_F1_1.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_STAT_SUBBSL_STAT1001_F1_1.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'I4T_JE_JVCX 1.0.31')
/
