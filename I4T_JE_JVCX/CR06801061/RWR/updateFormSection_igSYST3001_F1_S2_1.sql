rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igSYST3001_F1_S2_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igSYST3001_F1_S2_1.xml
...
where p.pagerefname='SYST3001_F1'
  and s.sectionrefname='igSYST3001_F1_S2'
