rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igSAE2001_F1_S3_1.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igSAE2001_F1_S3_1.xml
...
where p.pagerefname='SAE2001_F1'
  and s.sectionrefname='igSAE2001_F1_S3'
