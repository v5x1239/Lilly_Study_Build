...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igTRF3001_F1_S1_TRFPERF_TRF3001_F1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igTRF3001_F1_S1_TRFPERF_TRF3001_F1_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igTRF3001_F1_S1_TRFPERF_TRF3001_F1_3.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igTRF3001_F1_S1_TRFPERF_TRF3001_F1_4.sql >> RWRBatch.log
