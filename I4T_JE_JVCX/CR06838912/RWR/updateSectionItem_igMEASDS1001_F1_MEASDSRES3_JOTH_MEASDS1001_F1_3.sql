...
spool updateSectionItem_igMEASDS1001_F1_MEASDSRES3_JOTH_MEASDS1001_F1_3.xml
...
and s.sectionrevisionnumber = (select distinct s2.sectionrevisionnumber from 	pf_section s2,
				...
				where s.sectionid=s2.sectionid
				  ...
				  and h.editiondescription = 'RWRI4T_JE_JVCX 2.1.53')
/
