...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igCM4001_C2LF1_S1_CMINDC_PRIOR_CM4001_C2LF1_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateSectionItem_igCM4001_C2LF1_S1_CMINDC_PRIOR_CM4001_C2LF1_2.sql >> RWRBatch.log
