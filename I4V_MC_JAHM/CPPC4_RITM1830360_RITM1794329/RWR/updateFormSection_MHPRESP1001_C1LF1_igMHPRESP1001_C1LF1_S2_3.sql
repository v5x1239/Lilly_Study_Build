...
SPOOL updateFormSection_MHPRESP1001_C1LF1_igMHPRESP1001_C1LF1_S2_3.xml
...
where p.pagerefname='MHPRESP1001_C1LF1'
  and s.sectionrefname='igMHPRESP1001_C1LF1_S2'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'RWRI4V_MC_JAHM 2.1.18')
/
