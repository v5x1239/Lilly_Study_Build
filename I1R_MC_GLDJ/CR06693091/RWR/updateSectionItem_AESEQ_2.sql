rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateSectionItem_AESEQ_2.sql
Set echo off;
set pagesize 0;
set linesize 500;
set head off;
...
spool updateSectionItem_AESEQ_2.xml
