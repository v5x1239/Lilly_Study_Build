rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igCM3_F2_S2_3.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igCM3_F2_S2_3.xml
...
where p.pagerefname='CM3001_F2'
  and s.sectionrefname='igCM3_F2_S2'
