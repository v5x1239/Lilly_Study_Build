...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_igHEPA1_S2_1.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_igHEPA1_S2_2.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_igHEPA1_S2_3.sql >> RWRBatch.log
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_igHEPA1_S2_4.sql >> RWRBatch.log
...
@SQLPLUS  -s -l %uid%/%pid%@%dbinstance% @updateFormSection_igMHPRESP1001_F1_S1_4.sql >> RWRBatch.log
