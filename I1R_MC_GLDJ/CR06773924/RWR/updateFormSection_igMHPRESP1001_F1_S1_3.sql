rem		
rem 	Usage : sqlplus <trialuser>/<password>@<database> @updateFormSection_igMHPRESP1001_F1_S1_3.sql
SET ECHO OFF
SET FEEDBACK OFF
SET HEADING OFF
SET COLSEP "|"
...
SPOOL updateFormSection_igMHPRESP1001_F1_S1_3.xml
...
where p.pagerefname='MHPRESP1001_F1'
  and s.sectionrefname='igMHPRESP1001_F1_S1'
  ...
  and p.pagerevisionnumber = (select distinct p2.pagerevisionnumber from 	pf_page p2,
				  ...
				  and h.editiondescription = 'RWRI1R_MC_GLDJ 0.4.1')
/
