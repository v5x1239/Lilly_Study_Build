...
from I5B_MC_JGDJ.EX1001B_all where page in ('EX1001_LF1')) a left join (select distinct SUBJID, BLOCKID, nvl(BLOCKRPT,0) as BLOCKRPT, WEIGHT, WEIGHTU, (weight*20) as wh 
