...
CMSTDAT = CMSTDAT1;
CMENDAT = CMENDAT1;
if CMSTDAT1 ne . and AEENDAT1 ne . and CMSTDAT1 > AEENDAT1;
...
ods csv file=&irfilcsv trantab=ascii;
  title1 "ConMed";
  title2 "If Adverse Event is selected as Indication, and the AE Group ID entered matches an AE Group ID in Study Adverse Events CRF";

proc print data=CM029 noobs label WIDTH=min;
    var _all_;
  run;
