select 
 ...
 a.IRADLOCOTH from (select z.*,to_date(lpad(replace(IRADSTDATMO,'-99', '01'),2,'0')
      ...
      ||lpad(replace(IRADENDATDD,'-99', '30'),2,'0')|| IRADENDATYY,'MMDDYYYY') end  as IRADENDAT from I5B_MC_JGDJ.IRAD3001B_all z where page='IRAD3001_LF1' and iradloc is not null) a,
      ...
      ||lpad(replace(IRADENDATDD,'-99', '30'),2,'0')|| IRADENDATYY,'MMDDYYYY') end  as IRADENDAT from I5B_MC_JGDJ.IRAD3001B_all z where page='IRAD3001_LF1' and iradloc is not null) b
