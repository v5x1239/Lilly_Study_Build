...
if AEHEIRR eq 'Y' and AETELTMT eq 'GREATER THAN 7 DAYS';
...
ods csv file=&irfilcsv trantab=ascii;
  title1 "Events";
  title2 "If AEHEIRR = Y, and AETELTMT > 7 Days, AESTDAT must be > 7 days of EXSTDAT";

proc print data=AE4019 noobs label WIDTH=min;
    var _all_;
  run;
